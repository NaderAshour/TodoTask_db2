            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(onPressed:(){
                    DbHelper.instance.addtodo(TodoDetails(name:namecontroller.text, date: chooseDate!.millisecondsSinceEpoch, isChecked: false)

                    );
                    print(todo);
                    Navigator.of(context).pop();
                  },
                    child: Text('save',style: TextStyle(fontSize: 20,color: Colors.blue),),),
                ],
              ),
            ],
          ),
